export function PageBackground({
  ...
  return (
    <>
      ...
      <div className="pointer-events-none fixed inset-0 -z-5 bg-[radial-gradient(circle_at_top_left,_rgba(76,207,255,0.10),_transparent_28%),radial-gradient(circle_at_20%_70%,_rgba(255,153,102,0.08),_transparent_34%)]" />
    </>
  );
}
