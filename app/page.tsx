        ...
        <main className="relative z-10 px-4 pb-8 pt-0 sm:px-6 sm:pb-12 lg:px-10">
          ...
          >
            ...
            <motion.div
              ...
              className="hero-scroll-layer pointer-events-none absolute inset-x-0 bottom-[-17rem] z-40 hidden h-[34rem] overflow-hidden sm:bottom-[-15rem] sm:h-[38rem] md:block"
            >
