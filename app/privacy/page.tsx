...
export const metadata: Metadata = {
  ...
  description: "Privacy choices and analytics information for the Marcell Varga portfolio.",
    ...
    <main className="min-h-screen bg-[#f8f1e8] px-5 py-16 text-[#10202d] sm:px-8 lg:px-12">
      <article className="mx-auto max-w-3xl">
        ...
        <p className="mt-6 max-w-2xl text-lg leading-8 text-[#10202d]/72">
          This page explains the optional analytics used by this portfolio and how to change your
          choice. Last updated: 17 August 2026.
        </p>
        ...
        <div className="mt-12 space-y-10 text-base leading-7 text-[#10202d]/80">
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#10202d]">Analytics is optional</h2>
            <p className="mt-3">
              Analytics is off by default. It starts only after you choose “Allow analytics” in
              the privacy choices popover. “Not now” keeps it off. You can change your choice at
              any time with the Privacy control in the lower-right corner of the site.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-[#10202d]">What may be collected after opt-in</h2>
            <p className="mt-3">
          ...
          <section>
            ...
            <p className="mt-3">
              Optional measurements are processed by PostHog and Vercel. Their current privacy
              terms and data-processing details are available here:
            </p>
          ...
          <section>
            ...
            <p className="mt-3">
              You can withdraw analytics consent at any time using the Privacy control. You may
              also contact the operator about access, correction, deletion, or other privacy
              requests. Requests are handled subject to applicable law and reasonable identity
              verification.
            </p>
          </section>
        </div>
