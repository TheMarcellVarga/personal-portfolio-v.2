...
const IndexSigAnimatedIcon: React.FC<IconProps> = ({ isOpen, theme = "light" }) => {
  const strokeColor = theme === "dark" ? (isOpen ? "#e2f5ff" : "#7dd3fc") : isOpen ? "#053B50" : "#176B87";
    ...
    >
      ...
      <defs>
        <clipPath id="clip0_18_152">
          <rect width="85" height="36.7076" fill="#176B87" />
        </clipPath>
      </defs>
    </svg>
  );
