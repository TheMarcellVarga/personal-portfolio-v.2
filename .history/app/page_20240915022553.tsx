...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      {/* Drive Section */}
      <section className="sticky top-0 flex flex-col items-center justify-between h-[calc(3*100vh)] gap-1 w-full">
        <div className="flex w-4y/5 h-[calc(3*100vh)] text-5xl font-medium items-center justify-start">
