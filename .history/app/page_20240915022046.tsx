...
function useSmoothScroll() {
  ...
  const handleScroll = useCallback((event: WheelEvent) => {
    ...
    velocityRef.current = scrollAmount / timeDiff;
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      const decayFactor = Math.exp(-timeDiff * 0.01);
  ...
  return (
    <div ref={scrollContainerRef} className="overflow-y-auto h-screen">
      ...
      <section className="flex flex-col items-center justify-between h-screen gap-1 w-full ">
        <div className="flex w-4y/5 h-screen text-5xl font-medium items-center justify-start sticky">
