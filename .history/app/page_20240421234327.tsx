...
export default function Page() {
  return (
    <div className="m-4">
      <Header />
      <main className="flex min-h-screen flex-col p-9 gap-1.5">
        <div className="flex w-full text-4xl font-medium">
          Hey, I'm&nbsp;
          <span className="text-custom-blue font-bold">Marcell Varga</span>
        </div>
        <div className="flex w-full text-2xl font-light">UX & Frontend engineer</div>
      </main>
      <Footer />
    </div>
  );
