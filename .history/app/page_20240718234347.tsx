    ...
    >
      ...
      <main className="flex flex-col items-center justify-between h-screen m-4 gap-1">
        <div className="flex-grow pb-12 w-full flex flex-row items-center justify-strech gap-2">
          <div className="absolute w-fit z-">
          ...
          <div className="relative w-full h-full flex justify-end z-50">
            <svg
            ...
            <div className="absolute bottom-0 right-0 transform translate-x-1/2 z-10">
              <Image
                src="/images/personalpageprofilealt.png"
                alt="Profile Picture"
                layout="responsive"
