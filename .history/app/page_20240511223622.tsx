      ...
      <section>
        <div className="flex items-center justify-center w-full">
          <Globe
            ...
            labelsData={[copenhagenLabel]} // Hypothetical prop for labels
            pointAltitude={size.width} // Use the width of the window as the altitude
            pointColor="color"
            backgroundColor="rgba(0,0,0,0)"
            width={size.width ?? 0} // Use the width of the window as the width of the Globe
            height={size.height ?? 0 } // Use the height of the window as the height of the Globe
          />
        </div>
      </section>
