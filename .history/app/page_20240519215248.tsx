...
export default function Page() {
  ...
  const globeRef = useRef<any>(); // Replace 'any' with the actual type if known

  useEffect(() => {
    const intervalId = setInterval(() => {
      if (globeRef.current) {
        // Now TypeScript knows that globeRef.current has a 'rotation' property
        globeRef.current.rotation.y += 0.01; // Adjust the speed as necessary
      }
    }, 100);
