...
export default function Page() {
  useEffect(() => {
    ...
    setIsDarkMode(prefersDarkMode); // Update the state based on prefersDarkMode
  }, []);
  
  // Initialize isDarkMode to false directly, ensuring light mode is always the initial state
