              ...
              <div className="w-full flex flex-col gap-12">
                {projects.map((project) => (
                  <div key={project.title} className="w-full flex">
                    ...
                    <Link
                      href={project.link}
                      className={`w-full flex flex-col md:flex-row px-40 md:px-8 py-3.5 md:py-4 lg:py-4.5 2xl:py-8 rounded-lg transition-colors duration-200 ease-in-out ${
                        isDarkMode
                    ...
                    >
                      <div className="w-full md:w-fit relative overflow-hidden flex justify-center md:justify-start items-center">
                        <div className="w-[260px] sm:w-[250px] md:w-[300px] relative rounded-lg overflow-hidden">
                          <Image
                      ...
                      <div className="flex flex-col p-4 md:p-6 gap-2 w-full">
                        <div className="w-fit">
                          <div className="text-2xl">{project.title}</div>
                          <div className="text-md">{project.subTitle}</div>
                        </div>
