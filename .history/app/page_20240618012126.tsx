                  ...
                  <div key={project.title} className="w-full flex">
                    ...
                    <Link
                      ...
                      className={`w-full flex flex-row px-8 py-3.5 md:py-4 lg:py-4.5 2xl:py-8 rounded-lg transition-colors duration-200 ease-in-out ${
                        isDarkMode
                          ? "bg-gray-900 hover:bg-gray-700 border-transparent hover:border-gray-600 border"
                          : "bg-gray-100 hover:bg-gray-200 border-transparent hover:border-gray-300 border"
                      }`}
                    >
