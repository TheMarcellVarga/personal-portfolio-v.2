...
const darkModeIconUrl = "/icons/darkMode.svg";
    ...
    >
      ...
      <nav className="flex items-center">
        ...
        <button
          ...
          className="px-4 py-2 bg-gray-200 fill-pink-500 dark:bg-gray-800 dark:fill-pink-500 rounded"
        >
          <img
            ...
            width={240}
            height={240}
            className="px-4 py-2 text-black dark:text-pink fill-pink-500 dark:bg-gray-800 dark:fill-pink-500 rounded"
          />
        </button>
      </nav>
    </header>
...
export default function Page() {
  // Inside your Page component or a separate utility file
