...
export default function Page() {
  return (
    <div className="m-4">
      <Header />
      <main className="flex flex-col items-center justify-center h-screen p-9 gap-1">
        <div className="flex w-full text-4xl font-medium items-center justify-center">
          Hey, I'm&nbsp;
          <span className="text-custom-blue font-bold">Marcell Varga</span>
        </div>
        <div className="flex w-full text-2xl font-light items-center justify-center">UX & Frontend engineer</div>
      </main>
      <Footer />
    </div>
  );
