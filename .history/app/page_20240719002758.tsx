...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      <div className={`fade-top-bottom ${isDarkMode ? 'dark-mode' : 'light-mode'} pb-12 w-full flex flex-row items-center justify-strech gap-2`}>          <div className="absolute w-fit z-10">
