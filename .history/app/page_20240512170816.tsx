      ...
      <section className="flex flex-col items-center justify-between my-4 gap-24 w-full">
        ...
        <article className="w-full flex flex-col p-4">
          ...
          <div className="w-full flex justify-center items-center ">
            <div className="w-full ml-8 flex flex-col gap-12">
              {projects.map((project) => (
                <div key={project.title} className="w-full flex gap-12">
                  <div className="w-1/4 flex justify-start h-full relative rounded-lg overflow-hidden y-5">
                      ...
                      <div className="w-full h-full flex justify-center items-center">
                        <div className="flex-shrink-0">
                          <Image
                            ...
                            width={317} // Set the width to match the desired aspect ratio
                            height={225} // Set the height to match the desired aspect ratio
                          />
                        </div>
                      </div>
                    </Link>
                  </div>
                  <div className="text-lg flex flex-col mx-6 gap-2 w-full h-full">
