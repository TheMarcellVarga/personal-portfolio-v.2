  ...
  return (
    <header className="flex justify-between items-center w-full max-w-5xl">
      ...
      <nav className="flex space-x-4">
        {/* Links */}
        <Link href="/about">
          <div className="text-base font-medium text-custom-blue">About</div>
        </Link>
        <Link href="/work">
          <div className="text-base font-medium text-custom-blue">Work</div>
        </Link>
        <Link href="/contact">
          <div className="text-base font-medium text-custom-blue">Contact</div>
        </Link>
      </nav>
    </header>
  );
