...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      {/* Drive Section */}
      <section className="sticky top-0 flex flex-col items-center justify-between min-h-[100vh] max-h-[100vh] gap-1 w-full">
        <div className="flex w-4/5 h-[calc(100vh-200px)] text-5xl font-medium items-center justify-start">
