  ...
  return (
    <div className="px-4 pb-4 bg-custom-light dark:bg-custom-dark transition-colors duration-200 ease-in-out">
      ...
      <main className="flex flex-col items-center justify-between h-screen m-4 gap-1 w-full">
        <div className="flex-grow pb-12 w-full flex flex-col items-center justify-center gap-2">
          <div>
          ...
          <div>
            <Image
              ...
              width={30} // Set width explicitly
              height={20} // Set height explicitly
              objectFit="contain" // Changed to cover to ensure the image covers the area without distortion
            />
          </div>
        </div>
