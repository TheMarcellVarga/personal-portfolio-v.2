...
const copenhagen = {
  ...
  // Now you can use `theme` to conditionally apply dark mode styles and `toggleTheme` to switch themes
  // For example, to toggle theme on a button click:
...
export default function Page() {
  ...
  return (
    <div className={`px-4 pb-4 ${theme === 'dark' ? 'dark:bg-slate-900' : 'bg-slate-50'} transition-colors duration-200 ease-in-out`}>
      <Header
