...
export default function Page() {
  ...
  useEffect(() => {
    const storedPreference = Cookies.get('darkModePreference');
  ...
  const handleDarkModeToggle = () => {
    ...
    Cookies.set('darkModePreference', String(!isDarkMode));
  };

  return (
    <div className="px-4 pb-4 bg-slate-50 dark:bg-slate-900 transition-colors duration-200 ease-in-out">
      <Header
