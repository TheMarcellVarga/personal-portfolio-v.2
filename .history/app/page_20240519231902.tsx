            ...
            <div className="w-full flex flex-col gap-12">
              {projects.map((project) => (
                <div key={project.title} className="w-full flex">
                  ...
                  <Link
                    href={project.link}
                    className={`w-full flex flex-row p-8 rounded-lg transition-colors duration-200 ease-in-out ${
                      isDarkMode
                  ...
                  >
                    <div className="flex-shrink-0 flex justify-center items-center relative rounded-lg overflow-hidden">
                      <div className="w-full h-full flex justify-center items-center">
                        <div className="position-relative w-[80vw] pt-[56.25%] overflow-hidden">
                          {" "}
                          <Image
                    ...
                    <div className="flex-grow flex flex-col m-6 gap-2 w-full">
                      <div className="w-fit">
                        <div className="text-2xl">{project.title}</div>
                        <div className="text-md">{project.subTitle}</div>
                      </div>
