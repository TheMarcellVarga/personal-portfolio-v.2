      ...
      <nav className="flex items-center">
        ...
        <div className={`nav-overlay ${isOpen ? "open" : ""}`}>
          ...
          <button
            ...
            className="px-4 py-2 text-white md:text-black md:dark:text-gray-50 rounded"
          >
        ...
        <div className={`${isOpen ? "hidden" : "block"}`}>
          ...
          >
            ...
            <button
              onClick={toggleDarkMode}
              className="px-4 py-2 text-black dark:text-gray-50 rounded"
    ...
    <div className="px-4 pb-4 bg-custom-light dark:bg-custom-dark transition-colors duration-200 ease-in-out">
      ...
      <main className="flex flex-col items-center justify-between h-screen m-4 gap-1 w-full">
        <div className="flex-grow pb-12 w-full flex flex-row items-center justify-strech gap-2">
          <div>
            <div className="flex flex-row w-full text-7xl font-medium items-center justify-start text-black dark:text-gray-50 ">
              Hey, I'm&nbsp;
              <span className="text-custom-blue font-bold">Marcell Varga</span>
            </div>
            <div className="flex w-full text-4xl font-light items-center justify-start my-2 text-black dark:text-gray-50 ">
      ...
      <section className="flex flex-col items-center justify-between h-screen gap-1 w-full">
        <div className="flex w-full h-screen text-5xl font-medium items-center justify-start">
          <h2 className="text-2xl font-light text-justify m-8 leading-relaxed text-black dark:text-gray-50 ">
                  ...
                  <div key={project.title} className="w-full flex">
                    ...
                    >
                      ...
                      <div className="flex flex-col m-6 gap-2 w-full">
                        ...
                        <div className="text-md font-light text-justify text-black dark:text-gray-50">
            ...
            <div className="flex flex-col gap-12">
              {history.map((item, index) => (
                <div key={index} className="flex">
                  <div className="w-1/2">
                    <h3 className="text-xl text-black dark:text-gray-50">
                      {item.company}
                    </h3>
                  </div>
                  <div className="w-1/2">
                    <div className="flex flex-col gap-4">
                      <div>
                        <h3 className="text-lg text-black dark:text-gray-50">
                          {item.jobTitle}
                        </h3>
                        <h4 className="text-base font-light text-black dark:text-gray-50">
                          {item.time.start} -{" "}
                          {item.time.end ? item.time.end : "Present"}
                        </h4>
                      </div>
                      <div>
                        <div className="text-sm text-black dark:text-gray-50 ">
      ...
      {/* <section>
        <div className="flex w-full items-center justify-center text-5xl mt-60">
          <h3 className="text-2xl font-light text-justify leading-relaxed text-black dark:text-gray-50 ">
            Current Location:&nbsp;
