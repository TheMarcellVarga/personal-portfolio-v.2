...
const projects = [
  {
    title: "Flexible office resource management for hybrid work environments",
    description:
      "To optimise space resources and automate ad-hoc tasks to enhance employee productivity developed as a Microsoft Teams Integration",
    skills: [
      "HTML",
      "CSS",
      "JavaScript",
    ...
    link: "/projects/flexible-office-resource-management", // Example link to the project details page
  },
        ...
        <article className="my-8 w-full">
          ...
          {projects.map((project) => (
            <div key={project.title} className="flex gap-2">
              <div className="w-full h-auto bg-gray-200 rounded-lg"></div>
              <div className="flex flex-col m-6 gap-2">
                <Link href={project.link}>
                  <a className="text-lg font-light text-justify">
                    {project.title}
                  </a>
                </Link>
                <div className="flex flex-wrap gap-2">
