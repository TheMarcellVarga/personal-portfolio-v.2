...
export default function Page() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (scrollTop >= scrollThreshold) {
        stickySection?.classList.add('unstick');
      } else {
        stickySection?.classList.remove('unstick');
    }
    };
  ...
  return (
    ...
    >
      ...
      {/* Drive Section */}
      <section className="flex flex-col items-center justify-between h-screen gap-1 w-full sticky-section">
