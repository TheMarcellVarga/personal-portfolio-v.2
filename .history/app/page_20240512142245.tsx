...
export default function Page() {
  ...
  // Extend the Globe component to make it compatible with R3F
  extend({ Globe });

  // Then, you can use the Globe component within your Canvas as before
  const AutoRotatingGlobe = () => {
    ...
    useEffect(() => {
      ...
      // Cleanup function to remove the controls when the component unmounts
      return () => {
        controls.dispose();
      };
    }, []);
