      ...
      <main className="flex flex-col items-center justify-between h-screen m-4 gap-1 w-full">
        <div className="flex-grow pb-12 w-full flex flex-col items-center justify-center gap-">
          ...
          <div className="globe-container">
            <Globe
              globeImageUrl="//unpkg.com/three-globe/example/assets/earth-night.jpg"
              width={500}
              height={500}
              showGlobe={true}
              showAtmosphere={true}
              atmosphereColor="rgba(0,100,0,0.1)"
              atmosphereAltitude={0.1}
              onUpdate={(globe: { addMarker: (arg0: { id: string; city: string; country: string; coordinates: number[]; color: string; }) => void; }) => {
                globe.addMarker({
                  id: "copenhagen",
                  city: "Copenhagen",
                  country: "Denmark",
