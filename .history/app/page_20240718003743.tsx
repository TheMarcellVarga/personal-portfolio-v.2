...
export default function Page() {
  ...
  return (
    <div
      className={`px-4 pb-4 transition-colors duration-200 ease-in-out ${isDarkMode ? 'bg-gradient-dark' : 'bg-gradient-light'}`}
    >
      <Header
      ...
      <main className="flex flex-col items-center justify-between h-screen m-4 gap-1 w-full">
        <div className="flex-grow pb-12 w-full flex flex-row items-center justify-strech gap-2">
          ...
          <div className="triangle-container w-1/4 h-1/2 absolute right-48">
            <div className="triangle-shape" style={{
              '--gradient-start': isDarkMode ? 'var(--gradient-dark-start)' : 'var(--gradient-light-start)',
              '--gradient-end': isDarkMode ? 'var(--gradient-dark-end)' : 'var(--gradient-light-end)'
            }}></div>
            <Image
