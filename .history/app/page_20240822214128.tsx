    ...
    >
      ...
      <main className="flex flex-col items-center justify-between h-screen m-4 gap-1">
        <div className="flex-grow pb-12 w-full flex flex-row items-center justify-strech gap-2 fade-top-bottom">
          ...
          <div className="relative w-full h-full flex justify-end rounded-full">
          <div className="relative w-full h-full flex justify-end main-container rounded-full" style={{ background: "linear-gradient(to right, #02425C, #0F172A, #001822"}}>                className={`triangle-bg-svg ${
