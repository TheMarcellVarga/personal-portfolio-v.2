    ...
    <div className="m-4">
      ...
      <main className="flex min-h-screen flex-col p-9">
        <div className="flex w-full">
          I'm <span className="text-custom-blue font-bold">Marcell Varga</span>
        </div>
        ...
        <section className="mt-8">
          ...
          <div className="flex flex-wrap gap-2">
            {["React", "Figma", "Sketch", "JavaScript", "TypeScript", "Next.js", "Node.js", "Express.js", "HTML", "CSS", "UX Design", "UX Research", "RESTful APIs", "Git (Gitlab & Github)", "Svelte & SvelteKit", "Tailwind CSS", "Adobe CC Suite"].map((skill) => (
              <div key={skill} className="bg-custom-blue text-custom-teal text-sm px-2 py-1 rounded-md">
                {skill}
              </div>
            ))}
          </div>
