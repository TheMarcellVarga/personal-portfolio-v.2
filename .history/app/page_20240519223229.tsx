...
const DynamicGlobe = dynamic(() => import('globe.gl'), { ssr: false, loadingType: 'lazy' }); // Set ssr to false and loadingType to 'lazy'
...
export default function Page() {
  ...
  const globeRef = useRef<any>(null); // Assuming globeRef is a ref to the Globe component

  useEffect(() => {
    if (!globeRef.current) {
      DynamicGlobe().then(Globe => {
        // Initialize the globe with desired options
        const globe = Globe({
          // Your globe configuration options here
        });

        // Attach the globe to a DOM element
        globe().appendTo(globeRef.current);

        // Set the globe as initialized
      ...
      <section>
        ...
        <div className="flex items-center justify-center w-full">
          <Globe
            ...
            // autoRotationSpeed={0.1} // Adjust the speed as needed
            // labelText='name'
            // labelLabel='0.5'
          />
        </div>
