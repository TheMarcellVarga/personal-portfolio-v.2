...
export default function Page() {
  ...
  return (
    <div className="px-4 pb-4 bg-custom-light dark:bg-diagonal-gradient transition-colors duration-200 ease-in-out">
      <Header
        ...
        <section className="flex flex-col items-center justify-between mt-4 mb-4 gap-24 w-4/5">
                  ...
                  <div key={project.title} className="w-full flex">
                    ...
                    <Link
                      ...
                      className={`w-full flex flex-row px-8 py-3.5 md:py-4 lg:py-4.5 2xl:py-8 rounded-lg transition-colors duration-200 ease-in-out ${
                        isDarkMode
                          ? "bg-gray-800 hover:bg-gray-700 bg-opacity-80 border-transparent hover:border-gray-600 border"
                          : "bg-gray-50 hover:bg-gray-100 bg-opacity-80 border-transparent hover:border-gray-300 border"
                      }`}
                    >
          ...
          <article className="w-full p-4">
            ...
            <div className="flex flex-col gap-12">
              ...
              <div
                className="flex w-fit justify-start items-center gap-2"
              ...
              >
                <a
                  ...
                  className="flex w-fit justify-start items-center gap-2 hover:text-custom-blue dark:hover:text-custom-teal"
                >
