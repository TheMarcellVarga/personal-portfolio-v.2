                  ...
                  <div key={project.title} className="w-full flex">
                    ...
                    <Link
                      ...
                      className={`w-full flex flex-row px-8 py-3.5 md:py-4 lg:py-4.5 2xl:py-8 rounded-lg transition-colors duration-200 ease-in-out ${
                        isDarkMode
                          ? "bg-gray-800 hover:bg-gray-700 bg-opacity-60 border-transparent hover:border-gray-600 border"
                          : "bg-gray-50 hover:bg-gray-100 bg-opacity-60 border-transparent hover:border-gray-300 border"
                      }`}
                    >
