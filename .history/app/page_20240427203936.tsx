    ...
    >
      ...
      <nav className="flex items-center">
        ...
        <button
          ...
          className="px-4 py-2 bg-gray-200 dark:bg-gray-800 text-black dark:text-white text-black dark:text-pink fill-pink-500 dark:bg-gray-800 dark:fill-pink-500 rounded"
        >
          <img
