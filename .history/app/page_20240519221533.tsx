...
export default function Page() {
  ...
  const globeRef = useRef<GlobeInstance>(); // Assuming globeRef is a ref to the Globe component

  useEffect(() => {
    const rotateGlobe = () => {
      if (globeRef.current) {
        // Assuming the globe component exposes a method to rotate it
        globeRef.current.rotate();
      }
    };

    const intervalId = setInterval(rotateGlobe, 1000); // Adjust the interval as needed
      ...
      <section>
        ...
        <div className="flex items-center justify-center w-full">
          <Globe
            ...
            // autoRotateSpeed={0.1} // labelsData={[copenhagen]}
            // labelText='name'
            // labelLabel='0.5'
          />
        </div>
