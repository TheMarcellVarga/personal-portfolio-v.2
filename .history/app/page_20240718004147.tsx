    ...
    >
      ...
      <main className="flex flex-col items-center justify-between h-screen m-4 gap-1 w-full">
        <div className="flex-grow pb-12 w-full flex flex-row items-center justify-strech gap-2">
          ...
          <div style={{ position: "relative", width: "100%", height: "100%" }}>
            <div
              className={`w-1/4 h-1/2 absolute right-48 triangle-bg ${
                isDarkMode ? "bg-gradient-dark" : "bg-gradient-light"
              }`}
              dangerouslySetInnerHTML={{
                __html: `
        <svg width="665" height="686" viewBox="0 0 665 686" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M665 -109L0 686H665V-109Z" fill="${
            isDarkMode ? "#001822" : "#F8F8F8"
          }"/>
          <path d="M665 -109L0 686H665V-109Z" fill="url(#paint0_linear_364_239)"/>
          <defs>
            <linearGradient id="paint0_linear_364_239" x1="665" y1="-109" x2="-184.317" y2="250.252" gradientUnits="userSpaceOnUse">
      ...
      `,
            ...
            <Image
              ...
              height={100} // Set height explicitly
              objectFit="cover" // Changed to cover to ensure the image covers the area without distortion
              style={{ position: "relative", zIndex: 2 }} // Ensure the image appears above the SVG
            />
          </div>{" "}
        </div>
