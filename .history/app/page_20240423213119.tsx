...
const Header = () => {
  ...
  return (
    <header className="flex justify-between items-center w-full max-w-5xl z-10">
      ...
      <nav className="flex items-center">
        {/* Hamburger Menu */}
        <div className={`md:hidden ${isOpen ? "open" : ""}`} onClick={() => setIsOpen(!isOpen)}>
        ...
        <div className={`nav-overlay ${isOpen ? "open" : ""}`}>
          <div className={`${isOpen ? "block" : "hidden"} md:flex space-x-4`}>
            <Link href="/about">
              <div className="text-sm font-medium" style={{ color: isOpen ? "#eeeeee" : "inherit" }}>About</div>
            </Link>
            <Link href="/work">
              <div className="text-sm font-medium" style={{ color: isOpen ? "#eeeeee" : "inherit" }}>Work</div>
            </Link>
            <Link href="/contact">
              <div className="text-sm font-medium" style={{ color: isOpen ? "#eeeeee" : "inherit" }}>Contact</div>
            </Link>
          </div>
        </div>
      </nav>
  ...
  return (
    <div className="m-4">
      ...
      <section className="mt-8">
        <h2 className="text-xl font-light text-justify m-6">
          An adventurous UX & Frontend engineer with an enthusiasm for crafting
          delightful digital experiences. I thrive on solving complex problems
          through efficient design and love turning challenges into
          opportunities. Overcoming challenges through efficient design is what
