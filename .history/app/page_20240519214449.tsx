            ...
            <div className="w-full flex flex-col gap-12">
              {projects.map((project) => (
                <div key={project.title} className="w-full flex">
                  ...
                  <Link
                    href={project.link}
                    className="w-full flex flex-row bg-gray-50 p-8 rounded-lg hover:bg-gray-200 hover:border-gray-400 border-2 border-transparent transition-colors duration-200 ease-in-out"
                  >
