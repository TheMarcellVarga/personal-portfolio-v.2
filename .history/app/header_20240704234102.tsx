  ...
  return (
    ...
    >
      ...
      <nav className="flex items-center ">
        {/* Hamburger Menu */}
        <div
          className={`md:hidden z-12 w-12 overflow-visible ${isOpen ? "open" : ""}`}
...
/* Increase z-index when open to ensure it doesn't cover the close button */
.nav-overlay.open {
  z-index: 1; /* Adjust this value as necessary */
}`}</style>
