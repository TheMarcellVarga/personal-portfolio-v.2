        ...
        <div className="flex-grow pb-12 w-full flex flex-row items-center justify-strech gap-2">
          ...
          <div className="relative w-full h-full flex justify-end">
            <div className="relative w-full h-full flex justify-end">
              ...
              >
                <defs>
                  <filter id="blur-top-bottom">
                    <feGaussianBlur in="SourceGraphic" stdDeviation="10" result="top-blur"/>
                    <feGaussianBlur in="SourceGraphic" stdDeviation="10" result="bottom-blur"/>
                    <feBlend mode="normal" in="SourceGraphic" in2="top-blur" result="blurred-top"/>
                    <feBlend mode="normal" in="blurred-top" in2="bottom-blur" result="final-blur"/>
                  </filter>
                  <linearGradient
            ...
            <div className="absolute w-96 bottom-0 right-0 transform z-10">
              <Image
                src="/images/personalpageprofilealt.png"
                alt="Profile Picture"
                layout="responsive"
