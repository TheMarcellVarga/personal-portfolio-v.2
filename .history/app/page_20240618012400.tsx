      ...
      <nav className="flex items-center">
        ...
        <div className={`nav-overlay ${isOpen ? "open" : ""}`}>
          ...
          <button
            ...
            className="px-4 py-2 text-white md:text-gray-900 md:dark:text-gray-50 rounded"
          >
        ...
        <div className={`${isOpen ? "hidden" : "block"}`}>
          ...
          >
            ...
            <button
              onClick={toggleDarkMode}
              className="px-4 py-2 text-gray-900 dark:text-gray-50 rounded"
    ...
    <div className="px-4 pb-4 bg-custom-light dark:bg-custom-dark transition-colors duration-200 ease-in-out">
      ...
      <main className="flex flex-col items-center justify-between h-screen m-4 gap-1 w-full">
        <div className="flex-grow pb-12 w-full flex flex-row items-center justify-strech gap-2">
          <div>
            <div className="flex flex-row w-full text-7xl font-medium items-center justify-start text-gray-900 dark:text-gray-50 ">
              Hey, I'm&nbsp;
              <span className="text-custom-blue font-bold">Marcell Varga</span>
            </div>
            <div className="flex w-full text-4xl font-light items-center justify-start my-2 text-gray-900 dark:text-gray-50 ">
      ...
      <section className="flex flex-col items-center justify-between h-screen gap-1 w-full">
        <div className="flex w-full h-screen text-5xl font-medium items-center justify-start">
          <h2 className="text-2xl font-light text-justify m-8 leading-relaxed text-gray-900 dark:text-gray-50 ">
                  ...
                  <div key={project.title} className="w-full flex">
                    ...
                    <Link
                      ...
                      className={`w-full flex flex-row px-8 py-3.5 md:py-4 lg:py-4.5 2xl:py-8 rounded-lg transition-colors duration-200 ease-in-out ${
                        isDarkMode
                          ? "bg-slate-800 hover:bg-gray-700 border-transparent hover:border-gray-600 border"
                          : "bg-slate-100 hover:bg-slate-100 border-transparent hover:border-gray-300 border"
                      }`}
                    >
                      ...
                      <div className="flex flex-col m-6 gap-2 w-full">
                        ...
                        <div className="text-md font-light text-justify text-gray-900 dark:text-gray-50">
                ...
                <div key={index} className="flex">
                  ...
                  <div className="w-1/2">
                    <div className="flex flex-col gap-4">
                      <div>
                        <h3 className="text-lg text-gray-900 dark:text-gray-50">
                          {item.jobTitle}
                        </h3>
                        <h4 className="text-base font-light text-gray-900 dark:text-gray-50">
                          {item.time.start} -{" "}
      ...
      {/* <section>
        <div className="flex w-full items-center justify-center text-5xl mt-60">
          <h3 className="text-2xl font-light text-justify leading-relaxed text-gray-900 dark:text-gray-50 ">
            Current Location:&nbsp;
