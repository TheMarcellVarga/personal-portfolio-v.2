    ...
    <div className="mx-4 mb-4">
      ...
      <section className="flex flex-col items-center justify-between my-4 gap-24 w-full">
        ...
        <article className="mt-8 w-full">
          <h2 className="text-custom-blue px-2 text-sm font-bold mb-4 tracking-wider uppercase">
            Experience
          </h2>
        ...
        <article className="w-full">
          <h2 className="text-custom-blue px-4 text-sm font-bold mb-4 tracking-wider uppercase">
            Projects
          </h2>
