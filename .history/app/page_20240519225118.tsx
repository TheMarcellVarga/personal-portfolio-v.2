                ...
                <div key={project.title} className="w-full flex">
                  ...
                  <Link
                    ...
                    className={`w-full flex flex-row p-8 rounded-lg transition-colors duration-200 ease-in-out ${
                      isDarkMode
                        ? "bg-gray-800 hover:bg-gray-700 border-gray-600 hover:border-gray-500 border-2"
                        : "bg-gray-50 hover:bg-gray-100 border-gray-200 hover:border-gray-300 border-2"
                    }`}
                  >
