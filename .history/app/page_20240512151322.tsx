                ...
                <div className="w-full h-full relative rounded-lg overflow-hidden y-5">
                  <Link href={project.link} className="block h-48">
                    <div className="w-full h-full flex flex-col">
                      {" "}
                      {/* Adjust this container to use flex and flex-col */}
                      <div className="flex-shrink-0">
                        {" "}
                        {/* This container will adjust based on the image's aspect ratio */}
                        <Image
                          src={project.image} // Use the image path from the project object
                          alt={project.title} // Use the project title as the alt text
                          layout="responsive" // Make the image scale with the parent element
                          objectFit="contain" // Ensure the image fits within the container without being cropped or stretched
                          width={100} // Set a default width to ensure the container has a size
                          height={100} // Set a default height to ensure the container has a size
                        />
                      </div>
                      <div className="flex-grow bg-gray-200 p-4">
                        {" "}
                        {/* This div will fill the remaining space with a gray background */}
