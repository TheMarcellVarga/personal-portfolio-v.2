...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      {/* Drive Section */}
      <section className="sticky top-0 flex flex-col items-center justify-between h-[calc(3*100vh)] min-h-screen max-h-[300vh] gap-1 w-full">
        <div className="flex w-4y/5 min-h-screen max-h-[300vh] text-5xl font-medium items-center justify-start">
