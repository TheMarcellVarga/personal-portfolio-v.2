              ...
              <div className="w-full flex flex-col gap-12">
                {projects.map((project) => (
                  <div key={project.title} className="w-full flex">
                    ...
                    <Link
                      href={project.link}
                      className={`w-full flex flex-col md:flex-row px-8 py-3.5 md:py-4 lg:py-4.5 2xl:py-8 rounded-lg transition-colors duration-200 ease-in-out ${
                        isDarkMode
                    ...
                    >
                      <div className="w-fit relative overflow-hidden flex justify-start items-center">
                        <div className="w-[250px] md:w-[300px] relative flex justify-center items-center rounded-lg overflow-hidden">
                          <Image
