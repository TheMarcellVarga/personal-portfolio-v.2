...
import { ReactComponent as IndexSigAnimated } from "../public/icons/indexSigAnimated.svg";
import { ReactComponent as IndexSig } from "../public/icons/indexSig.svg";
...
const Header = () => {
  ...
  return (
    <header className={`sticky-header flex justify-between items-center w-full my-4 px-4 ${isVisible ? "" : "hidden"}`}>
      <div className="flex items-center">
        {/* Icon */}
        <Link href="/">
          {isScrollingDown ? <IndexSig /> : <IndexSigAnimated />}
        </Link>
      </div>
