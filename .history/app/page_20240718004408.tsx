      ...
      <main className="flex flex-col items-center justify-between h-screen m-4 gap-1 w-full">
        <div className="flex-grow pb-12 w-full flex flex-row items-center justify-strech gap-2">
          ...
          <div style={{ position: 'relative', width: '100%', height: '100%' }}>
            <svg className={`triangle-bg-svg ${isDarkMode ? 'dark-mode' : 'light-mode'}`} width="665" height="686" viewBox="0 0 665 686" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div style={{ position: 'absolute', bottom: 0, left: '50%', transform: 'translateX(-50%)', zIndex: 2 }}>
              <Image
                ...
                alt="Profile Picture"
                layout="responsive"
                width={200} // Adjusted width to ensure it fits within the SVG shape
