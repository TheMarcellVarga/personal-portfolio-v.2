...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      {/* Drive Section */}
      <section className="sticky top-0 flex flex-col items-center justify-between h-screen gap-1 w-full">
      ...
      <div className=" sticky top-0flex justify-center items-center">
