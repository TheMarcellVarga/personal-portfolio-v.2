        ...
        <div className={`nav-overlay ${isOpen ? "open" : ""}`}>
          <div className="flex flex-col md:flex-row md:justify-between md:items-center h-full">
            <div className={`${isOpen ? "block" : "hidden"} md:flex space-x-4`}>
              <Link href="/about">
                <div className="text-sm font-medium" style={{ color: isOpen ? "#eeeeee" : "inherit" }}>
                  About
                </div>
              </Link>
              <Link href="/work">
            ...
            <div className={`${isOpen ? "hidden" : "block"} md:flex justify-center items-end`}>
              <button onClick={toggleDarkMode} className="px-4 py-2 text-black dark:text-white rounded">
