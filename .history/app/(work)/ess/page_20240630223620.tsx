                        ...
                        {item.description.map((desc, descIndex) => (
                          <div key={descIndex}>
                            ...
                            <div className="mt-2">
                              {item.description.map((desc, descIndex) => (
                                <div key={descIndex}>
                                  <div className={`flex ${desc.bySide === "true"? "flex-row" : "flex-col"} gap-4`}>
                                    {Array.isArray(desc.picture)? (
                                      desc.picture.map((pictureObj, pictureIndex) => {
                                        if (typeof pictureObj === 'string') {
                                          ...
                                          return (
                                            <div key={pictureIndex} className="w-full object-cover">
                                              {pictureObj.bySide === "true"? (
                                                <img src={pictureObj.src} alt="" className="w-1/2 h-auto" />
                                              ) : (
                                                <img src={pictureObj.src} alt="" className="w-full h-auto" />
                                              ))}
                                            </div>
                                          );
                                        }
                                      ...
                                      <img src={desc.picture || ""} alt="" className="w-full object-cover" />
                                    )}
                                  </div>
                                ))
                              )}
