                            ...
                            <div className="mt-2 flex flex-wrap flex-row">
                              {Array.isArray(desc.picture)? (
                                desc.picture.map((pictureUrl, pictureIndex) => {
                                  ...
                                  const widthClass = `w-${Math.floor(100 / (totalPictures / (pictureIndex + 1)))}/100`;

                                  return (
                                    <div key={pictureIndex} className={widthClass}>
                                      <Image
                                        src={pictureUrl}
                                        alt="Dynamic Alt Text Based on Picture"
                                        layout="responsive"
                                ...
                                // Handle the case when there's only one picture or no array provided
                                <Image
                                  src={desc.picture || ""}
