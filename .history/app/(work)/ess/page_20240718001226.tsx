                      ...
                      <div className="text-sm text-black dark:text-white ">
                        {item.description.map((desc, descIndex) => (
                          <div key={descIndex}>
                            ...
                            <div className="mt-2 flex flex-wrap justify-center items-center w-2/3">
                                        ...
                                        {group.map(
                                          (pictureUrl, pictureIndex) => (
                                            <Image
                                              ...
                                              layout="fixed"
                                              width={550} // Fixed width for all images
                                              height={100} // Fixed height for all images
                                              objectFit="cover"
                                              className="rounded-lg mx-2" // Apply large border-radius and existing margin
                                            />
                                          )
                                        )}
                                      </div>
