                              ...
                              {Array.isArray(desc.text) &&
                                desc.text.map((text, index) => (
                                  <React.Fragment key={index}>
                                    ...
                                    {desc.picture[index] &&
                                    typeof desc.picture[index] === "string" ? (
                                      <Image
                                      ...
                                      // Handle the case where desc.picture[index] is an array
                                      // For example, take the first item or concatenate all items
                                      <Image
                                        src={
                                          typeof desc.picture[index] ===
                                          "string"
                                            ? desc.picture[index]
                                            : desc.picture[index][0] ?? ""
                                        }
                                        alt={`Description Picture ${index}`}
                                        layout="responsive"
                                        width={300}
