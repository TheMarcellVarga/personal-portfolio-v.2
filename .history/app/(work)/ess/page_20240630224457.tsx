                      ...
                      <div className="text-sm text-black dark:text-white ">
                        {item.description.map((desc, descIndex) => (
                          <div key={descIndex}>
                            ...
                            >
                              {Array.isArray(desc.picture) ? (
                                desc.picture.map((picture, pictureIndex) => {
                                  // Check if the current item is an object with a bySide property
                                  const isObjectWithBySide =
                                    typeof picture === "object" &&
                                    picture.hasOwnProperty("bySide");
                                  return (
                                    <img
                                      src={desc.picture}
                                      alt=""
