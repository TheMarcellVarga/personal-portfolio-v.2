                            ...
                            <div className="py-2">
                              {Array.isArray(desc.picture) ? (
                                <div className="flex space-x-4">
                                  {" "}
                                  {/* Render pictures side by side */}
                                  {desc.picture.map(
                                    (pictureUrl, pictureIndex) => (
                                      <div key={pictureIndex} className="w-1/3">
                                        <Image
                                          src={pictureUrl}
                                          alt={`Description ${descIndex} Picture ${pictureIndex}`}
                                          layout="responsive"
                              ...
                              ) : typeof desc.picture === "string" ? (
                                <Image
                                  src={desc.picture}
                                  alt={`Description ${descIndex} Picture`}
                                  layout="responsive"
                                  width={150}
                                  height={100}
                                  objectFit="cover"
