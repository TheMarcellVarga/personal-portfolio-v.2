                      ...
                      <div className="text-sm text-black dark:text-white ">
                        {item.description.map((desc, descIndex) => (
                          <div key={descIndex}>
                            ...
                            <div className="mt-2 flex flex-wrap justify-center items-center w-full h-full">
                                        ...
                                        {group.map(
                                          (pictureUrl, pictureIndex) => (
                                            <Image
                                              ...
                                              objectFit="cover"
                                              className="rounded-lg max-height-10" // Apply large border-radius and existing margin
                                            />
                                          )
                                        )}
                                      </div>
