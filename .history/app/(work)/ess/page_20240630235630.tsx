                        ...
                        {item.description.map((desc, descIndex) => (
                          <div key={descIndex}>
                            ...
                            <div className="mt-2 flex flex-wrap flex-row">
                              {Array.isArray(item.description[0].picture)? (
                                item.description[0].picture.map((pictureUrl, pictureIndex) => {
                                  const totalPictures = item.description[0].picture.length;
                                  let widthClass = '';
                                  switch (totalPictures) {
                                    case 2:
                                      widthClass = 'w-1/2';
                                      break;
                                    case 3:
                                    ...
                                    case 4:
                                      ...
                                      break;
                                    default:
                                      widthClass = 'w-1/2'; // Default to half width if no specific case matches
                                  }

                                  return (
                                    <div key={pictureIndex} className={widthClass}>
                                      <Image
                                        src={pictureUrl}
                                        alt="Dynamic Picture"
                                        layout="responsive"
                                ...
                                <Image
                                  src={item.description[0].picture || ""}
                                  alt="Single Picture"
                                  layout="responsive"
                                  width={150} // Adjust width as needed
                                  height={100} // Adjust height as needed
