...
const ESS = () => {
  ...
  useEffect(() => {
    ...
    // Your existing useEffect logic for setting dark mode based on preference
    const setDarkModeBasedOnPreference = () => {
      const prefersDarkMode = window.matchMedia("(prefers-color-scheme: dark)").matches;
      setIsDarkMode(prefersDarkMode);
      Cookies.set('darkMode', prefersDarkMode.toString(), { expires: 365 });
    };
    ...
    const listener = (e: {
      ...
      Cookies.set('darkMode', e.matches.toString(), { expires: 365 }); // Update the cookie when preference changes
    };
