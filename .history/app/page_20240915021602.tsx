...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      {/* Drive Section */}
      <section id="intro-section" className="flex flex-col items-center justify-between h-screen gap-1 w-full">
      ...
      const observer = new IntersectionObserver((entries) => {
        entries.forEach(entry => {
          if (entry.isIntersecting) {
            // Prevent scrolling for 3 seconds when the section enters the viewport
            ...
            }, 3000); // Remove event listeners after 3 seconds
          }
        });
      });
