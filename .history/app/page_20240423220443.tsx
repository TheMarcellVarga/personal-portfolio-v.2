    ...
    <div className="m-4">
      ...
      <main className="flex flex-col items-center justify-between h-screen m-4 gap-1 w-full">
        <div className="flex-grow py-12 w-full flex flex-col items-center justify-center gap-">
          <div className="flex w-full text-7xl font-medium items-center justify-start">
            Hey, I'm&nbsp;
        ...
        <div className="py-12 flex flex-col items-center justify-start">
        </div>
        <div className="pb-12 flex flex-col items-center justify-start">
          <Image
