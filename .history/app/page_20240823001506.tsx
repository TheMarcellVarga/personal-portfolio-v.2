  ...
  return (
    ...
    >
      ...
      <main className="flex flex-col items-center justify-between h-screen m-4 gap-1">
        <div className="flex-grow pb-12 w-full flex flex-row items-center justify-strech gap-2 fade-top-bottom mx-12">
          ...
          <div className="relative w-full h-full flex justify-end">
            <div
              ...
              // }}
            />
            {/* <div className="relative w-full h-full flex justify-end main-container rounded-2lg rounded-">
              <svg
