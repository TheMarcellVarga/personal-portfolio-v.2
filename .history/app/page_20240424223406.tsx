    ...
    <div className="m-4">
      ...
      <section className="flex flex-col items-center justify-between my-4 gap-1 w-full">
        ...
        <article className="my-8 w-full">
          ...
          <div className="flex flex-colflex-wrap gap-2">
            <div className="w-full h-full min-h-[100px] bg-gray-200 rounded-lg"></div>
            <div>
              <div className="text-lg font-light text-justify m-6">
                Flexible office resource management for hybrid work
                environments, to optimise space resources and automate ad-hoc
                tasks to enhance employee productivity developed as a Microsoft
                Teams Integration
              </div>
              <div>
                {[
