          ...
          <div className="flex flex-col gap-4">
            {projects.map((project) => (
              <div key={project.title} className="flex gap-2">
                <div className="flex flex-col m-6 gap-2 w-f">
                  <div className="w-full h-auto relative rounded-lg overflow-hidden y-5">
                    <Image
                      ...
                      objectFit="fill" // Adjust the image's aspect ratio to cover the container
                    />
                  </div>
                </div>
