...
const Footer: React.FC<FooterProps> = ({ isDarkMode, isOpen }) => {
  return (
    <div className="flex w-ful items-centerl">
      <div className="flex w-1/2 flex-row justify-between items-center px-4 pt-8">
        <div className="flex w-full opacity-50 text-sm">
          © 2024 Marcell Varga
        </div>
