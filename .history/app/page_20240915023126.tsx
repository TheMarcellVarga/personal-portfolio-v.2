...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      {/* Drive Section */}
      <section className="sticky top-0 flex flex-col items-center justify-between  gap-1 w-full">
        <div className="flex w-4/5 h-[200vh] text-5xl font-medium items-center justify-start">
