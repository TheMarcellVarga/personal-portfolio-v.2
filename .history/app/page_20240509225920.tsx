...
export default function Page() {
  useEffect(() => {
    ...
    console.log(prefersDarkMode); // Move this line inside the useEffect hook

    // If you need to use prefersDarkMode outside of this hook, consider setting it in a state
    setIsDarkMode(prefersDarkMode); // Assuming you want to update the state based on prefersDarkMode
  }, []);
