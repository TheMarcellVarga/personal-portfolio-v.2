...
export default function Page() {
  ...
  // Use the isBrowser variable to conditionally access the window object
  const prefersDarkMode = isBrowser
    ? window.matchMedia("(prefers-color-scheme: dark)").matches
    : false;

  const [isDarkMode, setIsDarkMode] = useState(prefersDarkMode); // Correctly initialize isDarkMode with prefersDarkMode  console.log(prefersDarkMode);
