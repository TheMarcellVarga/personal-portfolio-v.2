...
const IndexSigAnimatedIcon: React.FC<IconProps> = ({ isDarkMode, isOpen }) => {
  return (
    <svg
    ...
    >
      <g clipPath="url(#clip0_18_152)">
        <path
          stroke={isOpen ? "#053B50" : isDarkMode ? "white" : "#053B50"}
          strokeLinecap="round"
...
export default const IndexSigAnimatedIcon: React.FC<IconProps> = ({ isDarkMode, isOpen }) => {
  ;
