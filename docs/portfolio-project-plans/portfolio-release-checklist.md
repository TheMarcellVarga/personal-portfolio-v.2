...
| Analytics configuration | PostHog, Vercel Analytics, and Speed Insights initialize without an interrupting consent popover; PostHog autocapture and session recording remain enabled with masked inputs | Updated 2026-08-22 | Pending production verification |
